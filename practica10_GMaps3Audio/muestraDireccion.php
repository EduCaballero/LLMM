...
<html>
    ...
    <body>
        ...
        <p>
            ...
            <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCRQi6SgnSDNGPdNQblJsVHDcJlbOeE3ag&region=GB"></script>      

        </p>
        <?php
        //la key de la api de gmaps es AIzaSyCRQi6SgnSDNGPdNQblJsVHDcJlbOeE3ag
        $addr = $_GET["addr"];
        if (adrr!="trespuntos"){
        echo $addr;
        }
 ...
 var contentString = '<div id="content">' +
            ...
            function init() {
                ...
                <?php if($addr3!="3sitios") {   ?>
                    ,{address:"Madrid",data:"Café con leche in Plaza Mayor"}
                    ,{address:"Andorra",data:"Salgo un momento por tabaco"}
                    ,{address:"Sevilla",data:"Bamo' a la feriah"}
                <?php  } ?>
                        ])
